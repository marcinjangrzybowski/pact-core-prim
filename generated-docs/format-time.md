...
The `format-time` function returns a string that represents the formatted version of the specified time. The format of the returned string is determined by the format string argument provided to the function. This return value is useful in contexts where you need to display or log time data in a specific textual format.
